# E1R Unified 5Y Full Account V1 — 4C-2B-5 Regime Wiring Trade Window

Generated At: `2026-07-09T11:49:44.544124+00:00`
...
```json
{
  ...
  "smoke_ok": true,
  "has_daily_records_like_output": true,
  ...
  "critical_assumptions": {
    ...
    "e1r_shell_mode": "regime_wiring_trade_window_smoke",
    "strategy_variant": "E1R_UNIFIED_5Y_FULL_ACCOUNT_V1_REGIME_WIRING_TRADE_WINDOW_SMOKE",
    "version": "4C-2B-5-regime-wiring-trade-window-smoke"
  },
  "daily_regime_output_summary": {
    "daily_records_source_length": 61,
    "non_null_regime_count": 61,
    "non_null_active_mode_count": 61,
    "regime_counts": {
      "UPTREND": 61
    },
    "active_mode_counts": {
      "UPTREND_EMERGING_CONFIRMED_ENABLED": 61
    },
    "subclass_counts": {
      "None": 61
    },
    ...
    "last": {
      "date": "2021-07-09",
      "cash": 72173.67,
      "positions_value": 14617.47,
      "total_equity": 86791.14,
      "daily_return_pct": 0.1403,
      "drawdown_pct": 13.2089,
      "exposure_pct": 16.84,
...
```json
{
  ...
  "result_summary": {
    ...
    "metric_like_values": {
      ...
      "alpha_pct": -33.77,
      "max_drawdown_pct": 27.83,
      "profit_factor": 0.0,
      "sharpe_ratio": 0,
      "number_of_trades": 3,
      "total_trades_all": 3,
      "final_equity": 72173.67,
    ...
    "lists": {
      ...
      "daily_records": {
        ...
        "last": {
          "date": "2021-06-10",
          "cash": 76152.03,
          "position_value": 12427.73,
          "total_equity": 88579.76,
          "n_holdings": 3,
          "pending_orders": 1,
          "market_gate_state": "ALLOW",
          "spx_close": 4239.18,
      ...
      "e1r_candidates": {
        ...
        "first": {
          ...
          "e1r_uptrend_confirmed_eligible": true,
          "leader_rank": 1,
          "leader_score": 93.47,
          "rs_score": 91.7,
          "rs_prev20": 75.0,
          "rs_20d_improvement": 16.7,
          "momentum_score": 93.7,
          "momentum_acceleration": 36.9,
          "trend_health": 96.0,
          "close": 54.53,
          "ma20": 51.44,
          "ma50": 50.27,
      ...
      "trades": {
        ...
        "last": {
          ...
          "exit_regime": "UPTREND",
          "dominant_regime": "UPTREND",
          "entry_type": "E1R_UPTREND_EMERGING",
          "regime_day_weights": {
            "UPTREND": 22
          },
          "exit_type": "SIM_END",
...
- `STATEFUL_ENGINE_REGIME_WIRING_TRADE_WINDOW_OK_READY_FOR_FULL_5Y_UNIFIED_RUN`
