# E1R 4C-2C-4E-ENGINE-D — HistoricalDataAdapter Skeleton Smoke

Generated At: `2026-07-10T05:47:28.277748+00:00`

## Purpose
Implement HistoricalDataAdapter skeleton and verify it can produce a normalized HistoricalDataBundle without strategy execution.
...
[
  ...
  "src/e1r_engine/adapters/__init__.py",
...
```json
{
  ...
  "index_dir": "data/research/e1_5y/raw/indices",
  "regime_path": "data/research/e1_5y/regimes/spx_regime_daily.json",
  "prod_price_dir": "data/prices",
  "stock_files_seen": 542,
  "symbols_loaded": 540,
  "symbols_skipped": 2,
  "skipped_sample": {
...
```json
{
  "SPX": {
    ...
    "first_date": "2020-04-01",
    "last_date": "2026-06-18",
    "source_path": "data/research/e1_5y/raw/indices/SPX.json",
    "meta": {
  ...
  "NDX": {
    ...
    "first_date": "2020-04-01",
    "last_date": "2026-06-18",
    "source_path": "data/research/e1_5y/raw/indices/NDX.json",
    "meta": {
  ...
  "SOX": {
    ...
    "first_date": "2020-04-01",
    "last_date": "2026-06-18",
    "source_path": "data/research/e1_5y/raw/indices/SOX.json",
    "meta": {
...
```json
{
  ...
  "sample": {
    ...
    "2021-04-06": {
      "spx_regime": "UPTREND",
      "subclass": "NO_SUBCLASS",
      "source_path": "$.daily_regime.2021-04-06"
    },
    "2021-04-07": {
      "spx_regime": "UPTREND",
      "subclass": "NO_SUBCLASS",
      "source_path": "$.daily_regime.2021-04-07"
    },
    "2021-04-08": {
      "spx_regime": "UPTREND",
      "subclass": "NO_SUBCLASS",
      "source_path": "$.daily_regime.2021-04-08"
    },
    "2021-04-09": {
      "spx_regime": "UPTREND",
      "subclass": "NO_SUBCLASS",
      "source_path": "$.daily_regime.2021-04-09"
    }
  }
}
```
...
```json
{
  ...
  "new_engine_package_created": true,
  "bundle_shape_ok": true,
  "symbols_loaded_ge_500": true,
...
```json
{
  "historical_adapter_skeleton_passed": true,
  ...
  "conclusion": "HISTORICAL_DATA_ADAPTER_SKELETON_PASS_READY_FOR_ENGINE_STATE_CONTRACT",
  "recommended_next_action": "Proceed to 4C-2C-4E-ENGINE-E: define AccountState / Order / Fill / DecisionTrace contracts and unit smoke. Do not implement strategy core yet.",
  "engineering_rule": "HistoricalDataAdapter normalizes historical input only. It must not own trading logic, account state transitions, market gate, sizing, or regime branch execution."
}
```
